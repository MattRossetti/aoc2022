...
def find_reducers(monkeys):
    reducers = []
    for monkey in monkeys:
        reducers.append(monkey.test[0])
    return reducers


def find_lowest_common(reducers):
    found = False
    i = 1
...
reducers = find_reducers(monkeys)
lowest_common = find_lowest_common(reducers)
print(lowest_common)
    ...
    for monkey in monkeys:
        ...
        for item in monkey.items:
            ...
            if monkey.operation[1] == "old":
                ...
                if operator == "+":
                    worry_level = worry_level + int(monkey.operation[1])
            if worry_level > lowest_common:
                worry_level = worry_level % lowest_common
